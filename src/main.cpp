...
#include "bindings/py_algorithms/py_algo_poisson_image_editing.h"
...
PYBIND11_MODULE(pyccante, m)
{
    ...
    init_PoissonSolver(m);              // PoissonSolver algorithm_function
    init_computePoissonImageEditing(m); // computePoissonImageEditing algorithm_function
