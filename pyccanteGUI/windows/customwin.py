# This files contains the class CustomWindow derived from ImageWindow.
...
class CustomWindow(iw.ImageWindow):
    # CustomWindow is a child of ImageWindow.
    # CustomWindow is the window to see the preview
