...
class ImageWindow(QLabel):
    ...
    # This is a generic class, the one used by the GUI are:
    # - MainWindow for showing the loaded image without changes.
    # - CustomWindow for showing the preview image with changes.
    def __init__(self, win_width, win_height):
        ...
        # a Filter/Transformation the applied
