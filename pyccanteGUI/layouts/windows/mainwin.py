# This files contains the derived class ImageWindow.
...
class MainImgWindow(iw.ImageWindow):
    # MainImgWindow is a child of ImageWindow.
    # MainImgWindow is the window to see the read
    # image without modification applyed.
